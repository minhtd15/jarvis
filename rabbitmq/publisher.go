...
func RabbitMQPublisher(fileData []byte, ctx context.Context, fileType string, classService education_website.ClassService, fileName string) ([]qlda.AutoGenerated, error) {
